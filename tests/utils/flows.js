...
const WP_ADMIN_TASK_LIST = baseUrl + 'wp-admin/admin.php?page=wc-admin';
const WP_ADMIN_THEME = baseUrl + 'wp-admin/themes.php?theme=storefront';
const WP_ADMIN_THEMES = baseUrl + 'wp-admin/themes.php';
...
const StoreOwnerFlow = {
	...
	openTaskList: async () => {
		await page.goto( WP_ADMIN_TASK_LIST, {
			waitUntil: 'networkidle0',
		} );
	},

	openTheme: async () => {
		await page.goto( WP_ADMIN_THEME, {
			waitUntil: 'networkidle0',
		} );
	},

	openThemes: async () => {
		await page.goto( WP_ADMIN_THEMES, {
			waitUntil: 'networkidle0',
		} );
	},
