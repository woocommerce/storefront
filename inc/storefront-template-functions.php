	...
	function storefront_product_categories( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product-category' ) ) {
				...
				echo '<section class="storefront-product-section storefront-product-categories" aria-label="' . esc_html__( 'Product Categories', 'storefront' ) . '">';
	...
	function storefront_recent_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<section class="storefront-product-section storefront-recent-products" aria-label="' . esc_html__( 'Recent Products', 'storefront' ) . '">';
	...
	function storefront_featured_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<section class="storefront-product-section storefront-featured-products" aria-label="' . esc_html__( 'Featured Products', 'storefront' ) . '">';
	...
	function storefront_popular_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<section class="storefront-product-section storefront-popular-products" aria-label="' . esc_html__( 'Popular Products', 'storefront' ) . '">';
	...
	function storefront_on_sale_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<section class="storefront-product-section storefront-on-sale-products" aria-label="' . esc_html__( 'On Sale Products', 'storefront' ) . '">';
	...
	function storefront_best_selling_products( $args ) {
		if ( storefront_is_woocommerce_activated() ) {
			...
			if ( false !== strpos( $shortcode_content, 'product' ) ) {
				...
				echo '<section class="storefront-product-section storefront-best-selling-products" aria-label="' . esc_html__( 'Best Selling Products', 'storefront' ) . '">';
