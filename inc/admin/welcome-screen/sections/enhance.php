	...
	<div class="col boxed child-themes">
		...
		<div class="child-theme">
			<a href="http://www.woothemes.com/products/outlet?utm_source=product&utm_medium=upsell&utm_campaign=storefrontaddons">
				<img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/admin/welcome-screen/outlet.jpg'; ?>" alt="<?php esc_html_e( 'Proshop Child Theme', 'storefront' ); ?>" class="image-50" />
		...
		<div class="child-theme">
			<a href="http://www.woothemes.com/products/proshop?utm_source=product&utm_medium=upsell&utm_campaign=storefrontaddons">
				<img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/admin/welcome-screen/proshop.jpg'; ?>" alt="<?php esc_html_e( 'Proshop Child Theme', 'storefront' ); ?>" class="image-50" />
		...
		<div class="child-theme">
			<a href="http://www.woothemes.com/products/galleria?utm_source=product&utm_medium=upsell&utm_campaign=storefrontaddons">
				<img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/admin/welcome-screen/galleria.jpg'; ?>" alt="<?php esc_html_e( 'Galleria Child Theme', 'storefront' ); ?>" class="image-50" />
		...
		<div class="child-theme">
			<a href="<?php echo esc_url( wp_nonce_url( self_admin_url( 'update.php?action=install-theme&theme=boutique' ), 'install-theme_boutique' ) ); ?>">
				<img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/images/admin/welcome-screen/boutique.jpg'; ?>" alt="<?php esc_html_e( 'Boutique Child Theme', 'storefront' ); ?>" class="image-50" />
