...
<div id="child_themes" class="storefront-add-ons panel" style="padding-top: 1.618em; clear: both;">
	...
	<div class="feature-section col two-col">
		...
		<div class="col-1">
			<img src="<?php echo esc_url( get_template_directory_uri() ) . '/inc/admin/welcome-screen/img/proshop.jpg'; ?>" alt="<?php _e( 'Proshop Child Theme', 'storefront' ); ?>" class="image-50" />
			<h4><?php _e( 'Proshop', 'storefront' ); ?></h4>
			<p><?php _e( 'Unlock the true potential of your sports clothing and equipment store with ProShop! It\'s metropolitan design provides an active aesthetic giving your store oodles of character.', 'storefront' ); ?></p>
			<p style="margin-bottom: 2.618em;">
				<?php if ( 'Proshop' != $theme['Name'] ) { ?>
					<a href="http://www.woothemes.com/products/proshop/" class="button button-primary"><?php printf( __( 'Buy %s now', 'storefront' ), '<span class="screen-reader-text">Proshop</span>' ); ?></a>
				<?php } ?>
				<a href="http://www.woothemes.com/products/proshop/" class="button"><?php printf( __( 'Read more %sabout Proshop%s &rarr;', 'storefront' ), '<span class="screen-reader-text">', '</span>' ); ?></a>
			</p>
		</div>
