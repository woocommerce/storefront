		...
		sass: {
			dist: {
				...
				files: [{
					...
					'assets/css/woocommerce/extensions/payment-gateway-stripe.css': 'assets/css/woocommerce/extensions/payment-gateway-stripe.scss',
		...
		rtlcss: {
			main: {
				...
				src: [
					...
					'assets/css/woocommerce/extensions/payment-gateway-stripe.css',
